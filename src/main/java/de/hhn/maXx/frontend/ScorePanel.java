...
public class ScorePanel extends JPanel {
    ...
    public void paint(Graphics g) {
        ...
        g.drawString(String.valueOf(scoreOfWhite ? game.getScoreW().getNumerator() : game.getScoreB().getNumerator()), 2, 18);
        g.drawString(String.valueOf(scoreOfWhite ? game.getScoreW().getDenominator() : game.getScoreB().getDenominator()), 2, 42);
        g.dispose();
    }
}
